    ...
    return (
        <Box width="100%">
            ...
            <Grid container spacing={2} width="100%">
                <Grid>
                    <Typography variant="h5" fontWeight={600} color="text.primary" sx={{marginBottom: 2}}>Tecnológicas</Typography>
