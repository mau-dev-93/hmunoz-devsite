...
export default [
    {
        ...
        image_url: buildS3Url(ENV.bucket, ENV.region, "about_me/highway.png"),
    ...
    },
    {
        ...
        image_url: buildS3Url(ENV.bucket, ENV.region, "about_me/analysis.png"),
    ...
    },
    {
        ...
        image_url: buildS3Url(ENV.bucket, ENV.region, "about_me/pizza.png"),
